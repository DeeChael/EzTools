...
public class GPlayer implements org.gedstudio.library.bukkit.entity.GPlayer {
    ...
    public void setSkin(Skin skin) {
        ...
        final PacketPlayOutRespawn respawn = new PacketPlayOutRespawn(entityPlayer.getWorld().getWorldProvider().getDimensionManager(), entityPlayer.getWorld().getTime(), entityPlayer.getWorld().P(), entityPlayer.playerInteractManager.getGameMode());
