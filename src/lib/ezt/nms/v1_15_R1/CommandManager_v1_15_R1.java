...
import lib.ezt.nms.v1_15_R1.commands.CommandEzT;
import lib.ezt.nms.v1_15_R1.commands.CommandEzTItem;
import net.minecraft.server.v1_15_R1.CommandListenerWrapper;
import org.eztools.api.command.CommandManager;

public final class CommandManager_v1_15_R1 implements CommandManager {

    private final CommandDispatcher<CommandListenerWrapper> commandDispatcher;

    public CommandManager_v1_15_R1(CommandDispatcher<CommandListenerWrapper> commandDispatcher) {
