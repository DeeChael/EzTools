...
public final class TransferTool_v1_13_R1 implements TransferTool {
    ...
    private static JsonObject parseNBTTagCompound(NBTTagCompound nbtTagCompound) {
        ...
        for (String key : nbtTagCompound.getKeys()) {
            ...
            if (nbtBase instanceof NBTTagString) {
                nbtJsonObject.addProperty(key, "string$" + ((NBTTagString) nbtBase).b_());
            } else if (nbtBase instanceof NBTTagInt) {
                nbtJsonObject.addProperty(key, "int$" + ((NBTTagInt) nbtBase).e());
            } else if (nbtBase instanceof NBTTagLong) {
                nbtJsonObject.addProperty(key, "long$" + ((NBTTagLong) nbtBase).d());
            } else if (nbtBase instanceof NBTTagShort) {
                nbtJsonObject.addProperty(key, "short$" + ((NBTTagShort) nbtBase).f());
            } else if (nbtBase instanceof NBTTagByte) {
                nbtJsonObject.addProperty(key, "byte$" + ((NBTTagByte) nbtBase).g());
            } else if (nbtBase instanceof NBTTagFloat) {
                nbtJsonObject.addProperty(key, "float$" + ((NBTTagFloat) nbtBase).i());
                ...
                long[] longs = ((NBTTagLongArray) nbtBase).d();
                StringBuilder stringBuilder = new StringBuilder("[");
                for (long l : longs) {
                ...
                byte[] by = ((NBTTagByteArray) nbtBase).c();
                StringBuilder stringBuilder = new StringBuilder("[");
                for (byte b : by) {
    ...
    private static JsonArray parseNBTTagList(NBTTagList nbtTagList) {
        ...
        for (NBTBase base : nbtTagList) {
            if (base instanceof NBTTagString) {
                jsonArray.add("string$" + ((NBTTagString) base).b_());
            } else if (base instanceof NBTTagInt) {
                jsonArray.add("int$" + ((NBTTagInt) base).e());
            } else if (base instanceof NBTTagLong) {
                jsonArray.add("long$" + ((NBTTagLong) base).d());
            } else if (base instanceof NBTTagShort) {
                jsonArray.add("short$" + ((NBTTagShort) base).f());
            } else if (base instanceof NBTTagByte) {
                jsonArray.add("byte$" + ((NBTTagByte) base).g());
            } else if (base instanceof NBTTagFloat) {
                jsonArray.add("float$" + ((NBTTagFloat) base).i());
            } else if (base instanceof NBTTagDouble) {
                jsonArray.add("double$" + ((NBTTagDouble) base).asDouble());
            } else if (base instanceof NBTTagIntArray) {
                int[] ints = ((NBTTagIntArray) base).d();
                StringBuilder stringBuilder = new StringBuilder("[");
                for (int i : ints) {
                    stringBuilder.append(i).append(",");
                }
                ...
                long[] longs = ((NBTTagLongArray) base).d();
                StringBuilder stringBuilder = new StringBuilder("[");
                for (long l : longs) {
                    stringBuilder.append(l).append(",");
                }
                ...
                byte[] by = ((NBTTagByteArray) base).c();
                StringBuilder stringBuilder = new StringBuilder("[");
                for (byte b : by) {
                    stringBuilder.append(b).append(",");
                }
