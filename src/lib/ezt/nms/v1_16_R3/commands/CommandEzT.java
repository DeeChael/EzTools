    ...
    public static void register(CommandDispatcher<CommandListenerWrapper> commandDispatcher) {
        LiteralCommandNode<CommandListenerWrapper> literalCommandNode = commandDispatcher.register(
                net.minecraft.server.v1_16_R3.CommandDispatcher
                        ...
                        .then(
                                net.minecraft.server.v1_16_R3.CommandDispatcher.a("subcmd", StringArgumentType.string())
        ...
        commandDispatcher.register(net.minecraft.server.v1_16_R3.CommandDispatcher.a("eztools").redirect(literalCommandNode));
        commandDispatcher.register(net.minecraft.server.v1_16_R3.CommandDispatcher.a("eztool").redirect(literalCommandNode));
    }
