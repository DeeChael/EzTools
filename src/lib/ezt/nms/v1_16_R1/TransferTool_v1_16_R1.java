...
public final class TransferTool_v1_16_R1 implements TransferTool {
                ...
                if (value.contains("$")) {
                    ...
                    switch (splitted[0]) {
                        case "string":
                            ...
                            nbtTagCompound.set(key, NBTTagString.a(content));
                            break;
                        case "int":
                            if (count(value, "$") == 1) {
                                int i = Integer.parseInt(splitted[1]);
                                nbtTagCompound.set(key, NBTTagInt.a(i));
                            }
                            break;
                        case "long":
                            if (count(value, "$") == 1) {
                                long l = Long.parseLong(splitted[1]);
                                nbtTagCompound.set(key, NBTTagLong.a(l));
                            }
                            break;
                        case "float":
                            if (count(value, "$") == 1) {
                                float f = Float.parseFloat(splitted[1]);
                                nbtTagCompound.set(key, NBTTagFloat.a(f));
                            }
                            break;
                        case "double":
                            if (count(value, "$") == 1) {
                                double d = Double.parseDouble(splitted[1]);
                                nbtTagCompound.set(key, NBTTagDouble.a(d));
                            }
                            break;
                        case "short":
                            if (count(value, "$") == 1) {
                                short s = Short.parseShort(splitted[1]);
                                nbtTagCompound.set(key, NBTTagShort.a(s));
                            }
                            break;
                        case "byte":
                            if (count(value, "$") == 1) {
                                byte b = Byte.parseByte(splitted[1]);
                                nbtTagCompound.set(key, NBTTagByte.a(b));
                            }
                            break;
                        case "int_array":
                            if (count(value, "$") == 1) {
                ...
                if (value.contains("$")) {
                    ...
                    switch (splitted[0]) {
                        case "string":
                            ...
                            nbtTagList.add(NBTTagString.a(content));
                            break;
                        case "int":
                            if (count(value, "$") == 1) {
                                int i = Integer.parseInt(splitted[1]);
                        ...
                        case "short":
                            if (count(value, "$") == 1) {
                                short s = Short.parseShort(splitted[1]);
                                nbtTagList.add(NBTTagShort.a(s));
                            }
                            break;
                        case "byte":
                            if (count(value, "$") == 1) {
                                byte b = Byte.parseByte(splitted[1]);
                                nbtTagList.add(NBTTagByte.a(b));
                            }
                            break;
                        case "int_array":
                            if (count(value, "$") == 1) {
