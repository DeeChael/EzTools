...
public class GPlayer implements org.gedstudio.library.bukkit.entity.GPlayer {
    ...
    public void setSkin(Skin skin) {
        ...
        final PacketPlayOutRespawn respawn = new PacketPlayOutRespawn(entityPlayer.getWorld().getTypeKey(), entityPlayer.getWorld().getDimensionKey(), entityPlayer.getWorld().getTime(), entityPlayer.playerInteractManager.getGameMode(), entityPlayer.playerInteractManager.getGameMode(), true, true, true);
