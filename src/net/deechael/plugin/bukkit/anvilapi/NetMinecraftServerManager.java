...
public class NetMinecraftServerManager {

    private static NetMinecraftServerManager instance;

    public static NetMinecraftServerManager getInstance(){
        if(instance == null)
            instance = new NetMinecraftServerManager();
        return instance;
    }
